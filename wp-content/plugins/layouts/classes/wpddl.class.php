...
class WPDD_Layouts {
    ...
    public function add_layouts_admin_menu()
    {
        ...
        if (!$this->layouts_editor_page) {
            unset($pages['dd_layouts']['subpages']['dd_layouts_edit']);
        }
    ...
    public static function dd_layouts_debug()
    {
		if (!defined('WPTOOLSET_COMMON_PATH')) {
			define ('WPTOOLSET_COMMON_PATH', WPDDL_ABSPATH . '/toolset-common');
		} 
